            ...
            try {
                ...
                if ((approve || approveTxData) && action) {
                    ...
                    setSteps([
                        {
                            key: 'approve',
                            title: <span><FormattedMessage id="pages.loan.repay.confirm.steps.approve.title" /></span>,
                            buttonText: <span><FormattedMessage id="pages.loan.repay.confirm.steps.approve.button" /></span>,
                            stepText: <span> <FormattedMessage id="pages.loan.repay.confirm.steps.approve.step" /></span>,
                            description: <span><FormattedMessage id="pages.loan.repay.confirm.steps.approve.desc" /></span>,
                            loading: false,
                            error: '',
                        },
                        {
                            key: 'repay',
                            title: <span><FormattedMessage id="pages.loan.repay.confirm.steps.repay.title" /></span>,
                            buttonText: <span><FormattedMessage id="pages.loan.repay.confirm.steps.repay.button" /></span>,
                            stepText: <span> <FormattedMessage id="pages.loan.repay.confirm.steps.repay.step" /></span>,
                            description: <span><FormattedMessage id="pages.loan.repay.confirm.steps.repay.desc" /></span>,
                            loading: repaying ? true : false,
                            error: '',
                        },
                        {
                            key: 'completed',
                            title: <span><FormattedMessage id="pages.loan.repay.confirm.steps.completed.title" /></span>,
                            buttonText: <span> <FormattedMessage id="pages.loan.repay.confirm.steps.completed.button" /></span>,
                            stepText: <span> <FormattedMessage id="pages.loan.repay.confirm.steps.completed.step" /></span>,
                            description: <span><FormattedMessage id="pages.loan.repay.confirm.steps.completed.desc" /></span>,
                            loading: false,
                            error: '',
                        },
                    ]);
